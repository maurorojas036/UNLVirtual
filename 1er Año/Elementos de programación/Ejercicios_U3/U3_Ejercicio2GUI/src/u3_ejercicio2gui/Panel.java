...
public class Panel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        optRojo.setForeground(new java.awt.Color(255, 0, 0));
        optRojo.setText("Rojo");

        grupoColores.add(optVerde);
        optVerde.setForeground(new java.awt.Color(0, 153, 51));
        optVerde.setText("Verde");

        grupoColores.add(optAzul);
        optAzul.setForeground(new java.awt.Color(0, 51, 255));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (optRojo.isSelected()) {
            resultado.setText(mensaje.concat("Rojo"));
        }
        if(optAzul.isSelected()){
            resultado.setText(mensaje.concat("Azul"));
        }
        if(optVerde.isSelected()){
            resultado.setText(mensaje.concat("Verde"));
        }
